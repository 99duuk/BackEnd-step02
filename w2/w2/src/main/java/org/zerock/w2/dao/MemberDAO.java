...
public class MemberDAO {
    ...
    public MemberVO selectUUID(String uuid) throws Exception {
        ...
        @Cleanup Connection connection = ConnectionUtil.INSTANCE.getConnection();
        @Cleanup PreparedStatement preparedStatment = connection.prepareStatement(query);
        preparedStatment.setString(1, uuid);

        @Cleanup ResultSet resultSet = preparedStatment.executeQuery();
